...
public class TestingProject_02 extends BaseDriver {
    ...
    public void Test2() {
        ...
        WebElement mail = driver.findElement(By.id("Email"));
        action = actions.moveToElement(mail).click().sendKeys("testing4536@testing.com").build();
        action.perform();
    ...
    public void Test5() {
        ...
        WebElement notebook14 = driver.findElement(By.xpath("(//div[@class='details']//following::a)[1]"));
       ...
       newAdresSelectMenu.selectByVisibleText("New Address");
        ...
        action=actions.moveToElement(city).click().sendKeys("Istanbul").build();
        action.perform();

        WebElement adress1= driver.findElement(By.id("BillingNewAddress_Address1"));
        action = actions.moveToElement(adress1).click().sendKeys("Bakirköy").build();
        action.perform();

        WebElement zipCode = driver.findElement(By.name("BillingNewAddress.ZipPostalCode"));
        action=actions.moveToElement(zipCode).click().sendKeys("12345").build();
        action.perform();

        WebElement phoneNum = driver.findElement(By.id("BillingNewAddress_PhoneNumber"));
        action=actions.moveToElement(phoneNum).click().sendKeys("02164001001").build();
        action.perform();
